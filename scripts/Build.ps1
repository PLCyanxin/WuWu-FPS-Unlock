...
if(-not $hasSdk){
    ...
    & $install -Channel '10.0' -Quality 'GA' -Architecture 'x64' -InstallDir (Join-Path $tools 'dotnet') -NoPath
...
Copy-Item '.\components\PROVENANCE.json' '.\artifacts\win-x64\components\PROVENANCE.json' -Force
